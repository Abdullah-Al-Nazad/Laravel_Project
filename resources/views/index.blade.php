...
<body >
		...
		<div class="wrap-menu-header gradient1 trans-0-4">
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="logo">
						<a href="index.html">
							<img src="{{asset('pato-master/images/icons/logo.png')}}" alt="IMG-LOGO" data-logofixed="images/icons/logo2.png">
						</a>
					</div>
					...
					<div class="wrap_menu p-l-45 p-l-0-xl">
						<nav id="navbar" class="navbar main">
							<ul class="main_menu">
								...
								<li class="dropdown"><a href="#"><span>About</span> <i style="font-size: 20px;"
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url({{asset('pato-master/images/slide1-01.jpg')}});">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url({{asset('pato-master/images/master-slides-02.jpg')}});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url({{asset('pato-master/images/master-slides-01.jpg')}});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 txt1 t-center animated visible-false m-b-15"
