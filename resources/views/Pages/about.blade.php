...
<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url({{asset('pato-master/images/bg-title-page-03.jpg')}})">
	...
	<!-- Video -->
	<section class="section-video parallax100" style="background-image: url({{asset('pato-master/images/header-menu-01.jpg')}})">
			...
			<div class="row p-t-170">
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-romantic size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="{{asset('pato-master/images/our-story-02.jpg')}}" alt="IMG-OUR">
					</div>
				</div>
	...
	<!-- Banner -->
	<div class="parallax0 parallax100" style="background-image: url({{asset('pato-master/images/bg-cover-video-02.jpg')}})">
		...
		<div class="container t-center">
			...
			<div class="row">
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="{{asset('pato-master/images/avatar-02.jpg')}}" alt="IGM-AVATAR"></a>
						</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="{{asset('pato-master/images/avatar-03.jpg')}}" alt="IGM-AVATAR"></a>
						</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="{{asset('pato-master/images/avatar-05.jpg')}}" alt="IGM-AVATAR"></a>
						</div>
