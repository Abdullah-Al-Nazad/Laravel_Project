...
@section('content')
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url({{asset('pato-master/images/bg-title-page-02.jpg')}});">
	...
	<div class="section-gallery p-t-118 p-b-100">
		...
		<div class="wrap-gallery isotope-grid flex-w p-l-25 p-r-25">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events guests">
				<img src="{{asset('pato-master/images/photo-gallery-13.jpg')}}" alt="IMG-GALLERY">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				<img src="{{asset('pato-master/images/photo-gallery-14.jpg')}}" alt="IMG-GALLERY">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events">
				<img src="{{asset('pato-master/images/photo-gallery-15.jpg')}}" alt="IMG-GALLERY">
			...
			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				<img src="{{asset('pato-master/images/photo-gallery-16.jpg')}}" alt="IMG-GALLERY">
			...
			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				<img src="{{asset('pato-master/images/photo-gallery-17.jpg')}}" alt="IMG-GALLERY">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior guests">
				<img src="{{asset('pato-master/images/photo-gallery-18.jpg')}}" alt="IMG-GALLERY">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
				<img src="{{asset('pato-master/images/photo-gallery-19.jpg')}}" alt="IMG-GALLERY">
			...
			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
				<img src="{{asset('pato-master/images/photo-gallery-20.jpg')}}" alt="IMG-GALLERY">
			...
			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events">
				<img src="{{asset('pato-master/images/photo-gallery-21.jpg')}}" alt="IMG-GALLERY">
