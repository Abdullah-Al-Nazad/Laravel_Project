...
@section('content')
        ...
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1 item1-slick1"
                    style="background-image: url({{ asset('pato-master/images/slide1-01.jpg') }})">
                ...
                <div class="item-slick1 item2-slick1"
                    style="background-image: url({{ asset('pato-master/images/master-slides-02.jpg') }})">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                ...
                <div class="item-slick1 item3-slick1"
                    style="background-image: url({{ asset('pato-master/images/master-slides-01.jpg') }})">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
            ...
            <div class="row">
                <div class="col-md-6 p-t-45 p-b-30">
                    <div class="wrap-text-welcome t-center">
                        <span class="tit2 t-center">
                            Italian Restaurant and Community Center
                        </span>
                ...
                <div class="col-md-6 p-b-30">
                    <div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
                        <img src="{{ asset('pato-master/images/our-story-01.jpg') }}" alt="IMG-OUR">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-intro">
        <div class="header-intro parallax100 t-center p-t-135 p-b-158"
            style="background-image: url({{ asset('pato-master/images/bg-intro-01.jpg') }})">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="{{ asset('pato-master/images/intro-01.jpg') }}"
                                        alt="IMG-INTRO"></a>
                            </div>
                    ...
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="{{ asset('pato-master/images/intro-02.jpg') }}"
                                        alt="IMG-INTRO"></a>
                            </div>
                    ...
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="{{ asset('pato-master/images/intro-04.jpg') }}"
                                        alt="IMG-INTRO"></a>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="{{ asset('pato-master/images/our-menu-01.jpg') }}" alt="IMG-MENU">
                        ...
                        <div class="col-sm-6">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="{{ asset('pato-master/images/our-menu-05.jpg') }}" alt="IMG-MENU">
                        ...
                        <div class="col-12">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="{{ asset('pato-master/images/our-menu-13.jpg') }}" alt="IMG-MENU">
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-12">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="{{ asset('pato-master/images/our-menu-08.jpg') }}" alt="IMG-MENU">
                        ...
                        <div class="col-12">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="{{ asset('pato-master/images/our-menu-10.jpg') }}" alt="IMG-MENU">
                        ...
                        <div class="col-12">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="{{ asset('pato-master/images/our-menu-16.jpg') }}" alt="IMG-MENU">
        ...
        <div class="wrap-slick2">
            <div class="slick2">
                <div class="item-slick2 item1-slick2"
                    style="background-image: url({{ asset('pato-master/images/bg-event-01.jpg') }});">
                        ...
                        <div class="container">
                            ...
                            <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
                                ...
                                <a href="#" class="wrap-pic-blo2 bg1-blo2"
                                    style="background-image: url({{ asset('pato-master/images/event-02.jpg') }});">
                ...
                <div class="item-slick2 item2-slick2"
                    style="background-image: url({{ asset('pato-master/images/bg-event-02.jpg') }});">
                    <div class="wrap-content-slide2 p-t-115 p-b-208">
                        <div class="container">
                            <!-- - -->
                            <div class="title-event t-center m-b-52">
                            ...
                            <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false"
                                ...
                                <a href="#" class="wrap-pic-blo2 bg2-blo2"
                                    style="background-image: url({{ asset('pato-master/images/event-06.jpg') }});">
                                    <div class="time-event size10 txt6 effect1">
                ...
                <div class="item-slick2 item3-slick2"
                    style="background-image: url({{ asset('pato-master/images/bg-event-04.jpg') }});">
                    <div class="wrap-content-slide2 p-t-115 p-b-208">
                        <div class="container">
                            <!-- - -->
                            <div class="title-event t-center m-b-52">
                            ...
                            <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false"
                                ...
                                <a href="#" class="wrap-pic-blo2 bg3-blo2"
                                    style="background-image: url({{ asset('pato-master/images/event-01.jpg') }});">
                                    <div class="time-event size10 txt6 effect1">
                                        <span class="txt-effect1 flex-c-m">
                                            08:00 PM Tuesday - 21 November 2018
                                        </span>
    ...
    <!-- Booking -->
    <section id="book" class="section-booking bg1-pattern p-t-100 p-b-110">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 p-b-30">
                    ...
                    <form action="{{ route('book.store') }}" method="POST" class="wrap-form-booking">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Date -->
                                ...
                                <div class="wrap-inputpeople size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                    ...
                                    <select class="selection-1" name="people">
                                        ...
                                        <option value="02">2 people</option>
                                        <option value="03">3 people</option>
                                        <option value="04">4 people</option>
                                        <option value="05">5 people</option>
                                        <option value="06">6 people</option>
                                        <option value="07">7 people</option>
                                        <option value="08">8 people</option>
                                        <option value="09">9 people</option>
                ...
                <div class="col-lg-6 p-b-30 p-t-18">
                    <div class="wrap-pic-booking size2 bo-rad-10 hov-img-zoom m-l-r-auto">
                        <img src="{{ asset('pato-master/images/booking-01.jpg') }}" alt="IMG-OUR">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="wrap-content-slide3 p-b-50 p-t-50">
                        <div class="container">
                            <div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false"
                                data-appear="zoomIn">
                                <img src="{{ asset('pato-master/images/avatar-01.jpg') }}" alt="IGM-AVATAR">
                            </div>
                ...
                <div class="item-slick3 item2-slick3">
                    <div class="wrap-content-slide3 p-b-50 p-t-50">
                        <div class="container">
                            <div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false"
                                data-appear="zoomIn">
                                <img src="{{ asset('pato-master/images/avatar-04.jpg') }}" alt="IGM-AVATAR">
                            </div>
                ...
                <div class="item-slick3 item3-slick3">
                    <div class="wrap-content-slide3 p-b-50 p-t-50">
                        <div class="container">
                            <div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false"
                                data-appear="zoomIn">
                                <img src="{{ asset('pato-master/images/avatar-05.jpg') }}" alt="IGM-AVATAR">
                            </div>
    ...
    <section class="section-video parallax100"
        style="background-image: url({{ asset('pato-master/images/bg-cover-video-02.jpg') }})">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                            <a href="blog-detail.html"><img src="{{ asset('pato-master/images/blog-01.jpg') }}"
                                    alt="IMG-INTRO"></a>
                ...
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                            <a href="blog-detail.html"><img src="{{ asset('pato-master/images/blog-02.jpg') }}"
                                    alt="IMG-INTRO"></a>
                ...
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                            <a href="blog-detail.html"><img src="{{ asset('pato-master/images/blog-03.jpg') }}"
                                    alt="IMG-INTRO"></a>
