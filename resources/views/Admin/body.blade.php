                ...
                <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                        <div class="col-4 col-sm-3 col-xl-2">
                            <img src="{{ asset('admin/images/dashboard/Group126@2x.png') }}"
        ...
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-9">
                            <div class="d-flex align-items-center align-self-start">
                                <h3 class="mb-0">@if ($sell>$buy)
                                    {{$sell-$buy}}
                                @else
                                {{$buy-$sell}}
                                @endif</h3>
                                <p class="text-success ml-2 mb-0 font-weight-medium">@if ($sell>$buy)
                                    {{'Profit'}}
                                @else
                                {{'Loss'}}
                                @endif </p>
                    ...
                    <h6 class="text-muted font-weight-normal">Profit/Loss</h6>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                    ...
                    <div
                        ...
                        <div class="text-md-center text-xl-left">
                            ...
                            <p class="text-muted mb-0">20 Mar 2024, 01:00PM</p>
                        </div>
                        <div
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-12 col-xl-8 my-auto">
                            <div class="d-flex d-sm-block d-md-flex align-items-center">
                                <h2 class="mb-0">${{$sell/100*3.5}}</h2>
                                <p class="text-success ml-2 mb-0 font-weight-medium">+3.5%</p>
                            </div>
                            <h6 class="text-muted font-weight-normal">Since Today</h6>
                        </div>
                    ...
                    <div class="d-flex py-4">
                        <div class="preview-list w-100">
                            <div class="preview-item p-0">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('admin/images/faces/face12.jpg') }}"
