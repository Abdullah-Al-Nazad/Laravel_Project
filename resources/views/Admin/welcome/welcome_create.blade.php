...
@section('content')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                    <h1 class="card-title">Add Welcome</h1>
                    @if($errors->any())
    {{ implode('', $errors->all('<div>:message</div>')) }}
@endif
                <form class="forms-sample" action="{{route('welcome.store')}}" method="POST" 
                    ...
                    <div class="form-group">
                    <label for="exampleInputEmail3">Button</label>
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Button" name="button" >
                    </div>
                    <div class="form-group">
