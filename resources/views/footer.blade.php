		...
		<div class="container">
			<div class="flex-sb-m flex-w p-t-22 p-b-22">
				<div class="p-t-5 p-b-5">
					...
					<a href="https://www.facebook.com" class="fs-15 c-white">Facebook<i class="fa fa-facebook m-l-18" aria-hidden="true"></i></a>
	...
	<div class="modal fade" id="modal-video-01" tabindex="-1" role="dialog" aria-hidden="true">
		...
		<div class="modal-dialog" role="document" data-dismiss="modal">
			...
			<div class="wrap-video-mo-01">
				<div class="w-full wrap-pic-w op-0-0"><img src="{{asset('pato-master/images/icons/video-16-9.jpg')}}" alt="IMG"></div>
				<div class="video-mo-01">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/uSyIF_xWwao?si=wD9284kbD2Z2H79C" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
